...
class WDWT_Lightbox {
  ...
  public function __construct() {
    ...
    $this->params['slideshow_interval'] = intval($this->wdwt_front->get_param('lbox_slideshow_interval', array(), 5));
    $this->params['image_width'] = $this->wdwt_front->get_param('lbox_image_width', array(), 700);
    $this->params['image_height'] = $this->wdwt_front->get_param('lbox_image_height', array(), 500);
    $img_eff = $this->wdwt_front->get_param('lbox_image_effect', array(),  array('fade'));
    $this->params['image_effect'] = $img_eff[0];
    $this->params['enable_image_fullscreen'] = $this->wdwt_front->get_param('lbox_enable_image_fullscreen', array(), true);
    $this->params['open_with_fullscreen']= $this->wdwt_front->get_param('lbox_open_with_fullscreen', array(), false);
    $this->params['enable_image_ctrl_btn'] = $this->wdwt_front->get_param('lbox_enable_image_ctrl_btn', array(), true);
    $this->params['open_with_autoplay'] = $this->wdwt_front->get_param('lbox_open_with_autoplay', array(), false);
    $this->params['image_right_click'] = $this->wdwt_front->get_param('lbox_image_right_click', array(), false);
    $this->params['popup_enable_info'] = $this->wdwt_front->get_param('lbox_popup_enable_info', array(), true);
    $this->params['popup_info_full_width'] = $this->wdwt_front->get_param('lbox_popup_info_full_width', array(), true);
    $this->params['popup_info_always_show'] = $this->wdwt_front->get_param('lbox_popup_info_always_show', array(), false);
    $this->params['popup_enable_fullsize_image'] = false;
    $this->params['preload_images'] = true;
    $this->params['preload_images_count'] = 6;

    $wdwt_info_position = $this->wdwt_front->get_param('lbox_info_position', array(), array('right-top'));
    $wdwt_info_position_array = explode('-', $wdwt_info_position[0]);
    $wdwt_info_horiz = isset($wdwt_info_position_array[0]) ? $wdwt_info_position_array[0] : 'right';
    $wdwt_info_vert = isset($wdwt_info_position_array[1]) ? $wdwt_info_position_array[1] : 'top';

    $this->theme_row['lightbox_info_align'] = $wdwt_info_horiz;
    $this->theme_row['lightbox_info_pos'] = $wdwt_info_vert;
    /*colors*/
  ...
  public function view() {
    ...
    $rgb_wdwt_image_info_bg_color = $this->wdwt_front->hex2rgb($theme_row['lightbox_info_bg_color']);
    ...
    <style>
      ...
      .phone .wdwt_ctrl_btn_container,
      .tablet .wdwt_ctrl_btn_container {
      ...
      .wdwt_image_info {
        background: rgba(<?php echo $rgb_wdwt_image_info_bg_color['red']; ?>, <?php echo $rgb_wdwt_image_info_bg_color['green']; ?>, <?php echo $rgb_wdwt_image_info_bg_color['blue']; ?>, <?php echo number_format($theme_row['lightbox_info_bg_transparent'] / 100, 2, ".", ""); ?>);
        ...
        <div class="wdwt_btn_container">
          <div class="wdwt_ctrl_btn_container">
            ...
            if ($enable_image_ctrl_btn) {
              ?>
              <i title="<?php esc_attr_e('Play', "business-world"); ?>" class="wdwt_ctrl_btn wdwt_play_pause fa fa-play"></i>
              <?php
            }
            if ($enable_image_fullscreen) {
              if (!$open_with_fullscreen) {
                ?>
                <i title="<?php esc_attr_e('Maximize', "business-world"); ?>" class="wdwt_ctrl_btn wdwt_resize-full fa fa-resize-full "></i>
                <?php
              }
              ?>
              <i title="<?php echo esc_attr_e('Fullscreen', "business-world"); ?>" class="wdwt_ctrl_btn wdwt_fullscreen fa fa-fullscreen"></i>
            <?php }
            if ($popup_enable_info) { ?>
              <i title="<?php echo esc_attr_e('Show info', "business-world"); ?>" class="wdwt_ctrl_btn wdwt_info fa fa-info"></i>
              <?php
            }
            if ($popup_enable_fullsize_image) {
              ?>
              <a id="wdwt_fullsize_image" href="<?php echo $current_image_url; ?>" target="_blank">
                <i title="<?php echo esc_attr_e('Open image in original size.', "business-world"); ?>" class="wdwt_ctrl_btn fa fa-external-link"></i>
              </a>
              <?php
            }
            ?>
    ...
    <script>
      ...
      function wdwt_popup_resize() {
        ...
        if (typeof jQuery().fullscreen !== 'undefined' && jQuery.isFunction(jQuery().fullscreen) && !jQuery.fullscreen.isFullScreen()) {
          ...
          jQuery(".wdwt_resize-full").attr("title", "<?php esc_attr_e('Maximize', "business-world"); ?>");
          jQuery(".wdwt_fullscreen").attr("class", "wdwt_ctrl_btn wdwt_fullscreen fa fa-fullscreen");
          jQuery(".wdwt_fullscreen").attr("title", "<?php esc_attr_e('Fullscreen', "business-world"); ?>");
        }
      ...
      jQuery(document).ready(function () {
        ...
        jQuery(".wdwt_info").on(wdwt_click, function() {
          ...
          if (jQuery(".wdwt_image_info_container1").css("display") == 'none') {
            jQuery(".wdwt_image_info_container1").css("display", "table-cell");
            jQuery(".wdwt_info").attr("title", "<?php echo __('Hide info', "business-world"); ?>");
          }
          else {
            jQuery(".wdwt_image_info_container1").css("display", "none");
            jQuery(".wdwt_info").attr("title", "<?php echo __('Show info', "business-world"); ?>");
          }
        ...
        jQuery(".wdwt_resize-full").on(wdwt_click, function () {
          ...
          if (jQuery(".wdwt_resize-full").hasClass("fa-resize-small")) {
            ...
            jQuery(".wdwt_resize-full").attr("class", "wdwt_ctrl_btn wdwt_resize-full fa fa-resize-full");
            jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Maximize', "business-world"); ?>");
          }
          else {
            wdwt_popup_current_width = jQuery(window).width();
            wdwt_popup_current_height = jQuery(window).height();
            ...
            jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Restore', "business-world"); ?>");
            jQuery(".wdwt_spider_popup_close").attr("class", "wdwt_ctrl_btn wdwt_spider_popup_close_fullscreen");
          }
        ...
        jQuery(".wdwt_fullscreen").on(wdwt_click, function () {
          ...
          function wdwt_exit_fullscreen() {
            ...
            jQuery("#wdwt_spider_popup_wrap").on("fscreenclose", function() {
              ...
              jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Maximize', "business-world"); ?>");
              jQuery(".wdwt_fullscreen").attr("class", "wdwt_ctrl_btn wdwt_fullscreen fa fa-fullscreen");
              jQuery(".wdwt_fullscreen").attr("title", "<?php echo __('Fullscreen', "business-world"); ?>");
              if ((jQuery("#wdwt_spider_popup_wrap").width() < jQuery(window).width()) && (jQuery("#wdwt_spider_popup_wrap").height() < jQuery(window).height())) {
                jQuery(".wdwt_spider_popup_close_fullscreen").attr("class", "wdwt_spider_popup_close");
              }
            });
          ...
          if (typeof jQuery().fullscreen !== 'undefined' && jQuery.isFunction(jQuery().fullscreen)) {
            if (jQuery.fullscreen.isFullScreen()) {
              ...
              jQuery(".wdwt_fullscreen").attr("title", "<?php esc_attr_e('Exit Fullscreen', "business-world"); ?>");
              jQuery(".wdwt_spider_popup_close").attr("class", "wdwt_ctrl_btn wdwt_spider_popup_close_fullscreen");
        ...
        jQuery(".wdwt_play_pause, .wdwt_popup_image").on(wdwt_click, function () {
          if (jQuery(".wdwt_ctrl_btn").hasClass("fa-play")) {
            /* PLay.*/
            wdwt_play();
            jQuery(".wdwt_play_pause").attr("title", "<?php echo __('Pause', "business-world"); ?>");
            ...
            window.clearInterval(wdwt_playInterval);
            jQuery(".wdwt_play_pause").attr("title", "<?php echo __('Play', "business-world"); ?>");
