...
class WDWT_admin_view{
  ...
  public function color($element, $context='option', $opt_val='', $meta=array()){
    ...
    if($context== 'meta'){
      $optionname = WDWT_META.'[' .$element['name']. ']';
      $opt_val = (strpos($opt_val,"#")===0) ? $opt_val : "#".$opt_val;
    }
    elseif($context== 'mod'){
  ...
  public function text_preview($element, $context='option', $opt_val='', $meta=array()){
    ...
    <div class="font_preview_wrap" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <label class="typagrphy_label" for="" style="font-size:18px;font-size: 20px;font-family: Segoe UI;"><?php echo __('Preview', "business-world" ); ?></label>
  ...
  public function upload_single($element, $context='', $opt_val=''){
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class="optioninput" id="upload_images">
        ...
        <input class="upload-button button" type="button" id="uploader_<?php echo $element['name']; ?>" value="<?php esc_attr_e('Upload Image', "business-world"); ?>"/>
      </div>
    </div>
    <?php
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      ...
      <div class="wdwt_slide wdwt_slide_<?php echo $element['name']; ?> last_slide" id="wdwt_slide_<?php echo $element['name']; ?>_0">
        ...
        <div class="slide-from-base_url" style="margin-bottom:3%;">
          <div valign="middle"><h4><?php esc_html_e("Image URL","business-world"); ?></h4></div>
          <div>
            <input type="text" id="<?php echo $element['name']; ?>_url_0" size="50" value="" class="upload image_links_group" >

            <input type="button" class="<?php echo $element['name']; ?>_update-image slide_but_up" id="<?php echo $element['name']; ?>_update-button_0" value="<?php esc_attr_e("Update image", "business-world"); ?>">

            <input type="button" class="<?php echo $element['name']; ?>_remove-image slide_but_rem wdwt_btn_red" id="<?php echo $element['name']; ?>_remove-button_0" value="<?php esc_attr_e("Remove this slide", "business-world"); ?>"  />
          </div>
        </div>
        <!-- Image -->
        ...
        <div class="slide-from-base_desc" style="margin-bottom:3%;">
          <div valign="middle">
            <h4><?php esc_html_e("Image Description", "business-world"); ?></h4>
          </div>
          <div>
      ...
      <div class="slider-controls">
        <div valign="middle">
          <h4>
            <?php esc_html_e("Image", "business-world"); ?>
            <span class="hasTip" style="cursor: pointer;color: #3B5998;" title="<?php esc_attr_e("Using this option you can add images for the slider.","business-world"); ?>">[?]</span>
          </h4>
        </div>
        <div>
          ...
          <input class="upload_button_slide" type="button" id="<?php echo $element['name']; ?>_add-button" value="<?php esc_attr_e('Add new slide', "business-world"); ?>" />
        </div>
      </div>
    </div>
    <script type="text/javascript">
  ...
  public function diagram($element, $context='', $opt_val='', $meta=array()){
    if($context== 'meta'){
      $optionname = WDWT_META.'[' .$element['name']. ']';
      $diagram_title = isset($meta[$element['option']['diagram_title']]) ? $this->json_to_string($meta[$element['option']['diagram_title']]) : '' ;
      $optionname_title = WDWT_META.'[' .$element['option']['diagram_title']. ']';
      $diagram_percent = isset($meta[$element['option']['diagram_percent']]) ? $this->json_to_string($meta[$element['option']['diagram_percent']]) : '';
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      ...
      <div class="wdwt_diagram wdwt_diagram_<?php echo $element['name']; ?> last_percent" id="wdwt_diagram_<?php echo $element['name']; ?>_0">
        ...
        <div class="diagram-from-base_title">
          <div  valign="middle">
            <h3><?php esc_html_e("Title", "business-world"); ?></h3>
          </div>
        ...
        <div class="diagram-from-base_desc" style="margin-bottom:3%;">
          <div valign="middle">
            <h3><?php esc_html_e("Percent", "business-world"); ?></h3>
          </div>
          <div>
            <input type="text" class="diagram_percent_group" id="<?php echo $element['name']; ?>_percent_0"  value="" />%
            <input type="button" class="<?php echo $element['name']; ?>_remove-percent wdwt_btn_red" id="<?php echo $element['name']; ?>_remove-button_0" value="<?php esc_attr_e("Remove this percent", "business-world"); ?>"  />
          </div>
        </div>
      </div>
      ...
      <div class="diagram-controls">
        <div>
          ...
          <input class="add_percent wdwt_btn_blue" type="button" id="<?php echo $element['name']; ?>_add-button" value="<?php esc_attr_e('Add new percent value', "business-world"); ?>" />
        </div>
      </div>
    </div>
    <script type="text/javascript">
   ...
   *
   */
  protected function json_to_string($val){
    if(strpos($val,"||wd||")!== false)
      $val = $val;
    else if($val!='')
      $val = implode("||wd||",json_decode($val,true));
