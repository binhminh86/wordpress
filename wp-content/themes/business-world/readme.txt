...
=1.1.15=
new: class attribute allowed for several tags in footer text and slider description
new: target attribute allowed for links in slider description
fixed: excerpt of homepage pinned post
fixed: notice when the last recommended plugin activated
change: default image of slider and parallax header
change: shortcodes executed in the content of homepage pinned post

=1.1.14=
new: google maps API key option (PRO)
new: lightbox options (PRO)
change: font-awesome updated to version 4.5.0
fixed: prefixes in lightbox view code (PRO)
